...
![MCP](https://img.shields.io/badge/MCP%20servers-191919?style=flat-square&logo=anthropic&logoColor=white)
...
| :--- | :--- | :--- |
| [`ynt.codes`](https://ynt.codes) | Cloudflare Worker | A2A agent card, ARD catalog, envelope verifier, landing |
...
| **nagual** | Operating a market signal as a product, with its own on-chain identity and **published signed evidence** at [`nagual.ynt.codes`](https://nagual.ynt.codes). |
